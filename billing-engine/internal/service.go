...
import (
	"billing-engine/internal/modules/auth"
	"billing-engine/internal/modules/billing"
	"billing-engine/internal/modules/borrower"
	"billing-engine/internal/modules/loan"

	"billing-engine/configs"
...
func NewService(cfg *config.Config) factory.ServiceFactory {
	...
	modules := []factory.ModuleFactory{
		auth.NewModule(deps),
		billing.NewModule(deps),
		loan.NewModule(deps),
		borrower.NewModule(deps),
	}
